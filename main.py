...
LINE_CHANNEL_ACCESS_TOKEN = os.environ.get(
    ...
    "baSWvsupfACGN0GFkgOGgH0UIvLrQO51yZZCBDDTUWJi8Ng29Xaj1kF3DjiYm3LdOUxe7q8m+EvPfarjixeL6GBc41sAo4KzBtvMC+t2RPZXbuuzNfizb4pKSVOZDIlHaOytzNlzFW4Jl4VLQOe69AdB04t89/10/w1cDnyilFU="
).strip()
            ...
            "contents": [
                {"type": "text", "text": "⚠️ หากมีอาการข้อใดข้อหนึ่งด้านล่างนี้ ให้ถือเป็นภาวะฉุกเฉินระดับวิกฤต (Emergent) ทันที!", "size": "xs", "color": "#D93025", "weight": "bold", "wrap": True},
                {
                    ...
                    "contents": [
                        ...
                        {"type": "text", "text": "3. พูดไม่ชัด พูดติดขัด หรือสับสนนึกคำพูดไม่ออก", "size": "xs", "color": "#333333", "wrap": True},
            ...
            "contents": [
                {
                    ...
                    "color": "#D93025",
                    "height": "sm",
                    "action": {"type": "message", "label": "🚨 มีอาการวิกฤต (เรียกรถพยาบาล)", "text": "มีอาการวิกฤต"}
                },
                {
                    "type": "button",
                    "style": "secondary",
...
def get_health_summary(sender, group_id="ส่วนตัว", days=7):
    ...
    try:
        ...
        if res_data.get("status") == "empty":
            return f"⚠️ ไม่พบประวัติการวัดความดันของ คุณ{sender} ในช่วง {days} วันที่ผ่านมาค่ะ"
        ...
        if res_data.get("status") == "success":
            ...
            if avg_sys < 120 and avg_dia < 80:
                ...
                eval_text = "เริ่มค่อนข้างสูง ควรควบคุมโซเดียมและออกกำลังกายเพิ่ม"
            else:
...
def analyze_bp(sys_val, dia_val, sender_name="สมาชิก"):
    ...
    if dia_val < 60:
        ...
        dia_res = (
            ...
            "• ข้อควรปฏิบัติเรื่องยา: ไม่จำเป็นต้องทานยาใดๆ\n"
            "• กิจกรรมและการใช้ชีวิต: ออกกำลังกายปานกลางอย่างน้อย 150 นาทีต่อสัปดาห์ ทานอาหารที่มีประโยชน์เน้นผักผลไม้ และคุมรสเค็ม/โซเดียม บริหารจัดการความเครียด และนอนหลับ 7-8 ชั่วโมงต่อวัน\n"
        ...
        dia_res = (
            ...
            "• การสังเกตอาการ: มักไม่มีอาการแสดงชัดเจน อาจมีอาการมึนตึงศีรษะเบาๆ ช่วงเย็น หรือเมื่อตึงเครียด"
        )
    elif 90 <= dia_val <= 109:
        dia_res = (
...
def analyze_fpg(val, sender_name="สมาชิก"):
    if val < 100:
        ...
        res = (
            ...
            "• ข้อควรปฏิบัติ:\n"
            "  - อาหาร: ลดแป้งขัดขาว (ข้าวขาว, ขนมปังขาว) งดน้ำหวาน น้ำอัดลม และผลไม้รสหวานจัด เช่น องุ่น ทุเรียน\n"
...
def analyze_hbalc(val, sender_name="สมาชิก"):
    if val < 5.7:
        res = (
...
def analyze_hdl(val, gender="ชาย", sender_name="สมาชิก"):
    ...
    return (
        f"🟡 ผลการวิเคราะห์ค่า HDL (ไขมันดี) ของคุณ{sender_name}: {val} mg/dL ({gender})\n"
        f"• 💡 นิยาม: 'รถเก็บขยะประจำหลอดเลือด' 🚛 คอยวิ่งไปเก็บกวาดไขมันส่วนเกินที่เกาะตามผนังหลอดเลือด แล้วนำกลับไปทำลายที่ตับ ยิ่งมีค่านี้นำสูง หลอดเลือดยิ่งสะอาดและปลอดภัย ✨\n"
...
def analyze_triglyceride(val, sender_name="สมาชิก"):
    ...
    return (
        ...
        f"• ⚖️ การคุมน้ำหนักและกิจกรรม: หากน้ำหนักเกิน เพียงแค่ลดน้ำหนักลงได้ 5-10% ของน้ำหนักตัว ค่าไตรกลีเซอไรด์จะลดลงอย่างเห็นได้ชัด ร่วมกับการออกกำลังกายสม่ำเสมอ 🏃\n"
        f"• 💊 เรื่องการใช้ยา: หากค่าสูงมาก (เกิน 500) แพทย์จะจ่ายยากลุ่ม Fibrates หรือ Omega-3 สังเคราะห์ เพื่อป้องกันตับอ่อนอักเสบ ให้ทานตามแพทย์สั่งอย่างเคร่งครัด 👨‍⚕️\n"
...
def handle_text(event):
    ...
    if raw_text == "มีอาการวิกฤต":
        emergency_card = (
            ...
            f"2. นั่งพักในท่าที่สบาย ห้ามลุกเดินไปมา\n"
    ...
    if raw_text == "ไม่มีอาการวิกฤต":
        safe_card = (
            ...
            f"1. นั่งพักในห้องที่อากาศถ่ายเท เงียบสงบ เป็นเวลา 15 นาที\n"
    ...
    # 2. ค่าน้ำตาล HbA1c
    if 'hbalc' in raw_text.lower() or 'hba1c' in raw_text.lower() or 'สะสม' in raw_text:
